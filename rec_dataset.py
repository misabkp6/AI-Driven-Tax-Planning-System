...
def train_model(X: pd.DataFrame, y: pd.Series) -> Tuple[Pipeline, Dict, pd.DataFrame, pd.Series]:
...
def visualize_model_performance(pipeline, X_test, y_test, metrics, target_classes):
...
def main() -> None:
    try:
        ...
        # Train model
        print("\n🚀 Training model...")
        pipeline, metrics, X_test, y_test = train_model(X, y)
        
        # Generate visualizations
        visualize_model_performance(pipeline, X_test, y_test, metrics, target_classes)
